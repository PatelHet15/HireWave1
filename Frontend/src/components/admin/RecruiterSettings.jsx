...
const RecruiterSettings = () => {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      sendCandidateNotifications: user.notificationPreferences?.sendCandidateNotifications ?? true
    });
  }, [user, navigate]);
    ...
    try {
      const res = await axios.post(
        `${USER_API_END_POINT}/update-notification-preferences`,
        {
          ...
          sendCandidateNotifications: formData.sendCandidateNotifications
        },
        { 
          withCredentials: true,
          headers: {
            ...
            {activeTab === 'notifications' && (
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-medium">Send Candidate Notifications</h3>
                      <p className="text-sm text-gray-500">Send email notifications to candidates when their application status changes</p>
                    </div>
                    <Switch
                      checked={formData.sendCandidateNotifications}
                      onCheckedChange={() => handleSwitchChange('sendCandidateNotifications')}
                    />
                  </div>
